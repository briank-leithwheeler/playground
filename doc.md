...
> [!NOTE]
> Storage migrations will leverage VMware Storage vMotion to relocate virtual machine disks while VMs remain powered on, maintaining continuous operations and eliminating service downtime.
##### Storage Inventory
